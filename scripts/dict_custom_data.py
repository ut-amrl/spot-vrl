...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Randomly selecting a second patch that is different from the first patch
        ...
        # Selecting patches from different perspectives for the grid 
        patch_list_1 = []
        patch_list_2 = []
        ...
        for i in range(25):
            ...
            # randomply selecting a patch perspective from a location in the grid
            ...
            # Randomly selecting a second patch that is from a different 
            # perspective than the first patch (still same placein grid)
        ...
        # get fourier transform of inertial data
...
class MyDataLoader(pl.LightningDataModule):
	...
	def setup(self, stage=None):
        ...
        # Used to find mean statistics, but this was removed

		print('Train dataset size:', len(self.train_dataset))
		print('Val dataset size:', len(self.val_dataset))

    # Try reducing the number of workersif any exit unexpectedly
...
# Used for basic testing, not required for use
